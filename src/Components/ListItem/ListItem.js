...
export default function ListItem({ ticketDetails, listTitle, groupValue, priorityList }) {
  ...
  // Define icons for 'status' and 'priority' groups
  const icons = {
    'status': {
      'Backlog': (
    ...
    <div className="list-container">
      <div className="list-header">
        <div className="list-header-left">
          {/* Render icon based on groupValue and listTitle */}
